...
import restassured.response.createissue.pojos.CreateIssueResponse;
...
public class CreateIssue {
	...
	private void createIssue(CreateIssueRequest requestbody) {
		...
		Response response = given().log().all().pathParam("number", "3").headers("Content-Type", "application/json")
				// .auth().basic("pkavinas@gmail.com",
				// "ATATT3xFfGF0YJL76xXN6f9nV7w5LZxnhCtkapdHayYVGu_fcr3wXVuOonkOdS7h6dqLDOnY_-3GR0VY7OsMM19Cy-J7oYSUPariVkaiOQ-e0fS7_dK1W9uw-zCmoYzWpVwnXH7NZNyVw34984pNcfboKE7WCNm8mcKgZJn0-CWW6AN4PBv6PJ0=A99B85EA")
				.header("Authorization",
						"Basic ")
