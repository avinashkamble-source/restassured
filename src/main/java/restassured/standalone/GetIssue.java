...
import restassured.request.specbuilders.Requestspec;
...
public class GetIssue {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		/*
		 * Demo of request spec builders
		 * Demo of hamcrest matchers
		 * Demo of JSon schema matching
		 * Demo of extraction and Testng asset
		 * Demo of jsonpath and testng assert
		 * Demo - Map object can be created and passed to headers for validation
		 * 
		 */
		 given().log().all().spec(Requestspec.getRequestSpecification())
		 .get(
		...
		// .body("expand" , containsString("operations"))
		// .body("id", greaterThanOrEqualTo(1000))
